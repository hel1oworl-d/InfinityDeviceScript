...
Репозиторий автоматически скачивается и распаковывается программой [**UnisocToolInfinity**](https://github.com/hel1oworl-d/UnisocToolInfinity) в мастере первого запуска, а также может быть обновлён вручную кнопкой **«Восстановить / Обновить базу»** в настройках программы.
